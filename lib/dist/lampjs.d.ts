...
export declare const createState: <T>(
  value: T,
  builder?: ((val: T) => JSX.Element) | undefined
) => (newValue?: T | ((val: T) => T) | undefined) => stateObj<T>;
export declare const createEffect: <T extends (val?: any) => stateObj<any>>(
  cb: () => void,
  deps: T[]
) => void;
...
export declare const createAsyncCall: {
  ...
  ) => (cb: (val: asyncCallState<T>) => void, parser?: ((...args: any[]) => any) | undefined) => void;
};
export declare const Fragment: ({ children }: { children: JSX.Element }) => JSX.Element;
